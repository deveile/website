...
<body bg-dark>
  ...
  <header id="header" class="fixed d-flex align-items-center">
    ...
    <button class="btn btn-success fw-semibold" type="submit" name="btn_search">CARI</button>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="anggota.php">Anggota</a></li>
	...
	<center><h2>ANGGOTA TAEKWONDO RAVEN</h2></center>

	<br/>
	<a href="tambah_anggota.php" type="button" class="btn btn-dark">+ TAMBAH DATA</a>
	<br/>
	<br/>
	<table class ="table table-hover table-bordered table-dark">
		<tr>
			...
			<th style = "background-color:#000; color; #fff">Kelas</th>
		...
		if(isset($_GET['cari'])){
			$cari = $_GET['cari'];
			$data = mysqli_query($koneksi, "SELECT * FROM anggota2 WHERE id_anggota LIKE '%$cari%' OR nama LIKE '%$cari%' OR kelas LIKE '%$cari%'");
		  } else {
			$data = mysqli_query($koneksi, "SELECT * FROM anggota2");
		  }
		  ...
		  ?>
			<tr>
				...
				<td>
        <a href="edit_anggota.php?id_anggota=<?php echo $d['id_anggota']; ?>"type="button" class="btn btn-warning">EDIT</a>
        <a href="hapus_anggota.php?id_anggota=<?php echo $d['id_anggota'] ?>"type="button" class="btn btn-danger" onclick=" return confirm('Apakah anda yakin akan hapus')">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
